...
const Header = () => {
  ...
  const [schoolcodes, setSchoolcode] = useState();
  ...
  setSchoolcode(res.data.schoolcodes);
  
  }
  else{


  // req.data.session.destroy();
  ...
  const handleDel = () => {
    ...
    axios.delete('http://localhost:8082/logout').then(res =>{
          ...
          <li className="nav-item dropdown has-arrow main-drop">
            ...
            <div className="dropdown-menu menu-drop-user">
              ...
              <div className="profilename">
                ...
                <hr className="m-0" />
                <button onClick={handleDel} className="dropdown-item logout pb-0" >
                  <ImageWithBasePath

...
<div className="modal fade" id="add-fing-modal">
  ...
  <div className="modal-content">
    <div className="page-wrapper-new p-0">
      <div className="content">
        <div className="modal-header border-0 custom-modal-header">
          <div className="page-title">
            <h4>SUBMIT FINGERPRINT MODAL</h4>
          </div>
          <button
            type="button"
            className="close"
      ...
      >
        ...
        <h2></h2>
        <button id='clear' onClick={clearImage}>Clear Image</button>
        <button id='start' onClick={() =>{StartCapturing()}}>Capture Print</button>
        <button id='stop' onClick={stopCapturing}>Stop </button>
        ...
        <div style={{ padding: "4px 0px" }}>
          <label className="switch">
            <div className="button">
              <span className="fa fa-fingerprint fa-2xl" 
              // onClick={() => {
              //   CaptureFingerPrint();
              // }}
